...
describe '会員詳細画面のテスト' do
  ...
  let!(:post) { create(:post,customer_id: custoomer.id) }
  let!(:post2) { create(:post,customer_id: custoomer.id) }
  let!(:post3) { create(:post,customer_id: custoomer.id) }
  let!(:post4) { create(:post,customer_id: custoomer.id) }
  let!(:post5) { create(:post,customer_id: custoomer.id) }
  let!(:post6) { create(:post,customer_id: custoomer.id) }
  let!(:post7) { create(:post,customer_id: custoomer.id) }
  let!(:post8) { create(:post,customer_id: custoomer.id) }
  let!(:post9) { create(:post,customer_id: custoomer.id) }
  let!(:post10) { create(:post,customer_id: custoomer.id) }
  let!(:post11) { create(:post,customer_id: custoomer.id) }
